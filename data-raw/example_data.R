...
drivers <- data.frame(
  network = "Environmental", subnetwork = "Drivers",
  category = paste0("driver_", 1:15)
)
species <- data.frame(
  network = "Environmental", subnetwork = "Species",
  category = paste0("species_", 1:30)
)
actions <- data.frame(
  network = "Social", subnetwork = "Actions",
  category = paste0("action_", 1:9)
)
managers <- data.frame(
  network = "Social", subnetwork = "Managers",
  category = paste0("manager_", 1:9)
)
beneficiaries <- data.frame(
  network = "Social", subnetwork = "Beneficiaries",
